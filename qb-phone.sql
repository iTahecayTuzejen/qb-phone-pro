...
CREATE TABLE IF NOT EXISTS `player_jobs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8;qqbcoreframework_c3f9acbcoreframework_c3f9acapp_storeapp_storeapp_storeapp_storeapp_storeapp_store